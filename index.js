...
Do you follow it, or continue on your path?`)
    if (secondAnswer === 'follow it') {
        ...
        if(thirdAnswer === 'stay') {
            let forthAnswer = window.alert('You live happily amongs the cats for the rest of your days.')
        } else if (thirdAnswer === 'spread the word') {
            let forthAnswer = window.alert('After leaving the cat colony, you are never able to find it again; without proof, no one believes your story, which passes into legend nonetheless.')
        }
        ...
        if(thirdAnswer ==="ladder"){
            let forthAnswer = window.alert('After ascending a few feet up the ladder, one of its rungs snaps, and you comedically fall through each of the rungs below. Sheepish, you return home.')
...
lead you away from the dragon altogether. Which path do you take?`)
    if(secondAnswer === 'past the dragon'){
        ...
        if(secondAnswer === "stay"){
            ...
            let thirdAnswer = window.alert('Quickly, you run back to the caves entrance. Sheepish, you return home.')
        }
        ...
        if(thirdAnswer === 'draw it'){
            let forthAnswer = window.alert('ou draw the flower, capturing only a fraction of its beauty with your quill. You bring the drawing home, somewhat disappointed, but over time, discover joy in sharing it with your friends and family, recounting the story of your days as a sorcerer with the aid of the sketch.')

        }else if(thirdAnswer === "pick it"){
            let forthAnswer = window.alert('You pick the flower and bring it home, and all marvel at its brilliance. However, over time it fades and eventually crumbles to dust.')
        }
    }
}